      ...
      <nav className="navbar">
        <section className="navbar__wrapper">
          ...
          <section className="navbar__sitename-container">
            <div className="navbar__sitename-text">
              SeedFund
            </div>
          </section>
