      ...
      <li className="trending-projects__right-panel-list-item">
        <div className="trending-projects__right-panel-list-item-container">
          ...
          <div className="trending-projects__right-panel-list-item-info-container">
            <div>
              <NavLink to={'/project/' + id} className="trending-projects__right-panel-list-item-name">{title}</NavLink>
              <span className="trending-projects__right-panel-list-item-funding">{funding()}</span>
              <div>
                <NavLink to={'/project/' + id} className="trending-projects__right-panel-list-item-creator">
